<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Masters/Site.Master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="_Default" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
     ...
     <div class="col-lg-4 center-block text-center" style="background:#eeeeee; border-radius : 10px; padding-top:10px; padding-bottom:10px;">
		<form id="login-form" >
            <h3>Login</h3>
